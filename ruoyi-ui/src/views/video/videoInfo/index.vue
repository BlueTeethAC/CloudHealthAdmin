    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="访问路径" prop="videoPath">
          <el-button type="primary" @click="reviewVideo(form.videoPath)"
            >点击查看视频</el-button
          >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          type="success"
          @click="processSubmitForm(2)"
          v-show="form.status === 0"
          >审核通过</el-button
        >
        <el-button
          type="danger"
          @click="processSubmitForm(1)"
          v-show="form.status === 0"
          >审核不通过</el-button
        >
        <el-button
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除线上课程视频编号为"' + videoIds + '"的数据项？')
        .then(function () {
