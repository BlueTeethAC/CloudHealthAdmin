<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="系列上传者id" prop="seriesCreater">
        <el-input
          v-model="queryParams.seriesCreater"
          placeholder="请输入系列上传者id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="seriesInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系列上传者id" align="center" prop="seriesCreater" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="系列上传者id" prop="seriesCreater">
          <el-input v-model="form.seriesCreater" placeholder="请输入系列上传者id" />
        </el-form-item>
        <el-form-item label="上传时间" prop="seriesUploadDate">
          <el-date-picker clearable
  ...
  data() {
    return {
      ...
      rules: {
        ...
        seriesCreater: [
          { required: true, message: "系列上传者id不能为空", trigger: "blur" }
        ],
        seriesUploadDate: [
