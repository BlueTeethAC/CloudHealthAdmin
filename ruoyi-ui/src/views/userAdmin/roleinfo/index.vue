  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['userAdmin:roleinfo:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['userAdmin:roleinfo:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['userAdmin:roleinfo:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['userAdmin:roleinfo:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="权限id" prop="roleId">
          <el-input v-model="form.roleId" placeholder="请输入权限id" />
        </el-form-item>
        <el-form-item label="角色名" prop="roleName">
...
<script>
import { listRoleinfo, getRoleinfo, delRoleinfo, addRoleinfo, updateRoleinfo } from "@/api/userAdmin/roleinfo";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getRoleinfo(infoId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除角色权限编号为"' + infoIds + '"的数据项？').then(function() {
        return delRoleinfo(infoIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('userAdmin/roleinfo/export', {
        ...this.queryParams
