<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="输入人 id" prop="userId">
        <el-input
      ...
      <el-form-item label="咨询单状态" prop="state">
    ...
    <el-table v-loading="loading" :data="consultationFormList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="输入人 id" align="center" prop="userId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="健康问卷得分" prop="score">
          <el-input v-model="form.score" placeholder="请输入健康问卷得分" />
        </el-form-item>
        <el-form-item label="输入日期" prop="inputDate">
          <el-date-picker clearable
        ...
        <el-form-item label="输入人 id" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入输入人 id" />
        </el-form-item>
        <el-form-item label="咨询单状态" prop="state">
          <el-select v-model="form.state" placeholder="请选择咨询单状态">
            <el-option
              v-for="dict in dict.type.consultation_status"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="问卷答题记录" prop="questionnaireRecordings">
          <el-input v-model="form.questionnaireRecordings" placeholder="请输入问卷答题记录" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const ConsultationFormIds = row.ConsultationFormId || this.ids;
      this.$modal.confirm('是否确认删除咨询信息编号为"' + ConsultationFormIds + '"的数据项？').then(function() {
        return delConsultationForm(ConsultationFormIds);
      }).then(() => {
        this.getList();
